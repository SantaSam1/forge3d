...
const SF_TOKEN = (import.meta.env.VITE_SKETCHFAB_TOKEN as string) || 'f8a254d9b48c40e9befa26962a40abec';
...
export default function Library({ onClose, onOpenInStudio }: LibraryProps) {
  ...
  useSEO({
    title: isRu ? 'Библиотека 3D моделей — 3D-Prin' : '3D Model Library — 3D-Prin',
    description: isRu
      ? 'Бесплатная библиотека тысяч 3D моделей. Локальные ассеты, Sketchfab и модели сообщества. Скачивайте в GLB, OBJ, STL.'
      : 'Free library of thousands of 3D models. Local assets, Sketchfab and community models. Download GLB, OBJ, STL.',
    canonical: '/library',
  });
